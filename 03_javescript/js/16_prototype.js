...
function Truck(name, capacity) {
    // 1. 부모생성자함수 호출 - 현재 객체 기준으로 Car생성자함수 호출(super 대신) 
    Car.apply(this, [name]);
...
const test4 = () => {
    // const books = [];
    // books.push(new Book("전지적 푸바오 시점", "에버랜드 동물원", "22_000"));
    // books.push(new Book("장수하는 뇌", "시라사와 다쿠지", "18_000"));
    // books.push(new Book("사랑의 8가지 법칙", "제이 셰티", "19_500"));
